...
import { Calculator, Zap, Sun, ChevronRight, Sparkles, Clock } from 'lucide-react';
  ...
  return (
    <section className="w-full bg-gradient-to-b from-[#1c355f] to-[#1c2f58] py-12 px-4 md:px-8 relative overflow-hidden">
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-10 right-5 w-40 h-40 bg-[#ffed00] rounded-full blur-3xl"></div>
        <div className="absolute bottom-10 left-5 w-48 h-48 bg-[#ffed00] rounded-full blur-3xl"></div>
      </div>
