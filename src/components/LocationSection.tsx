...
const position = [-18.914723929666533, -48.25505439403919]; // Coordenadas de Uberlândia
        ...
        <div className="w-full max-w-xl h-[400px] rounded-2xl overflow-hidden shadow-xl border border-gray-100">
          <MapContainer center={position} zoom={15} scrollWheelZoom={false} className="h-full w-full z-0">
            ...
            <Marker position={position}>
              <Popup>Ato Energia — Matriz</Popup>
            </Marker>
          </MapContainer>
        </div>
        ...
        <div className="w-full max-w-xl text-gray-800 space-y-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <a
                href="https://www.google.com/maps/dir/?api=1&destination=Avenida+Belarmino+Cotta+Pacheco,+411,+Uberlândia,+MG"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block mt-3 px-5 py-2 bg-blue-700 hover:bg-blue-800 text-white rounded-full text-sm font-semibold transition"
              >
                COMO CHEGAR
              </a>
            </div>
