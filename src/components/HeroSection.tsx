        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight drop-shadow-md">
              Transformando o{" "}
              <span className="text-blue-300">futuro energético</span> do Brasil
            </h1>

            <p className="text-xl leading-relaxed max-w-xl drop-shadow-md">
              Soluções energéticas inteligentes e sustentáveis para residências
              e empresas. Reduza seus custos com energia.
            </p>
          ...
          <div className="relative">
                ...
                {[
                  {
                    ...
                    title: "Economia",
                    description: "Reduza sua conta de energia."
                  },
                  {
                    icon: <BarChart2 className="h-8 w-8 text-green-400" />,
                    title: "Sustentabilidade",
                    description: "Energia limpa e renovável para o planeta"
                  },
                  {
                    icon: <DollarSign className="h-8 w-8 text-blue-400" />,
                    title: "Investimento",
                    description: "Retorno garantido em médio prazo"
                  },
                  {
                    icon: <ArrowRight className="h-8 w-8 text-purple-400" />,
                    title: "Futuro",
                    description: "Tecnologia de ponta para sua energia"
                  }
                ].map((item, index) => (
                  <div
                    key={index}
            ...
            <div className="absolute -bottom-4 -right-4 bg-[#fcec04] hover:bg-[#f9e800] px-6 py-3 rounded-lg shadow-lg">
              <p className="text-[#040c6c] font-medium text-sm">
