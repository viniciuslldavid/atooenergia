          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { name: 'Eficiência Energética', path: '/servicos/eficiencia-energetica' },
                { name: '...', path: '/servicos/consultoria' },
                { name: '...', path: '/servicos/comercializacao' },
                { name: '...', path: '/servicos/automacao' },
                { name: '...', path: '/servicos/manutencao' },
              ].map((service, index) => (
                <li key={index}>
                  <Link
                    to={service.path}
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex">
                ...
                <span className="text-gray-400">(34) 98421-4728</span>
              </li>
              <li className="flex">
                <Phone className="h-5 w-5 text-blue-400 mr-3 shrink-0" />
                <span className="text-gray-400">(34) 3045-1053</span>
              </li>
              <li className="flex">
                <Mail className="h-5 w-5 text-blue-400 mr-3 shrink-0" />
                <span className="text-gray-400">contato@atoenergia.com</span>
              </li>
            </ul>

            <div className="mt-8">
              <h4 className="font-medium text-sm uppercase tracking-wider text-gray-400 mb-4">Inscreva-se em nossa newsletter</h4>
              <form className="flex">
                <input
                  type="email"
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <Link to="/politica-de-privacidade" className="text-gray-500 hover:text-gray-300 text-sm">
                Política de Privacidade
              </Link>
              <Link to="/termos-de-uso" className="text-gray-500 hover:text-gray-300 text-sm">
                Termos de Uso
              </Link>
