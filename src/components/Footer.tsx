...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gradient-to-r from-[#040c6c] via-[#0a1c49] to-[#183d74] text-white pt-16 pb-8">
            ...
            <div className="mt-4">
              ...
              <div className="flex flex-row items-center gap-4">
                ...
                <div className="relative group">
                  <img
                    src='https://res.cloudinary.com/dzk36cfdq/image/upload/v1753653054/visa_bwic4u.png'
                    alt="Visa"
                ...
                <div className="relative group">
                  <img
                    src='https://res.cloudinary.com/dzk36cfdq/image/upload/v1753653054/mastercard_qjl4hr.png'
                    alt="Mastercard"
                    className="w-8 h-auto hover:scale-105 transform transition-transform duration-200"
                  />
                  <span className="absolute left-1/2 -translate-x-1/2 bottom-10 bg-gray-800 text-white text-xs rounded py-1 px-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                ...
                <div className="relative group">
                  <img
                    src='https://res.cloudinary.com/dzk36cfdq/image/upload/v1753653053/boleto_mfmdel.png'
                    alt="Boleto"
                    className="w-8 h-auto hover:scale-105 transform transition-transform duration-200"
                  />
                  <span className="absolute left-1/2 -translate-x-1/2 bottom-10 bg-gray-800 text-white text-xs rounded py-1 px-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                ...
                <div className="relative group">
                  <img
                    src='https://res.cloudinary.com/dzk36cfdq/image/upload/v1753653053/dinheiro_iy0wt7.png'
                    alt="Dinheiro"
                    className="w-8 h-auto hover:scale-105 transform transition-transform duration-200"
                  />
                  <span className="absolute left-1/2 -translate-x-1/2 bottom-10 bg-gray-800 text-white text-xs rounded py-1 px-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                ...
                <div className="relative group">
                  <img
                    src='https://res.cloudinary.com/dzk36cfdq/image/upload/v1753653054/financiamento_ufbh3m.png'
                    alt="Financiamento"
                    className="w-8 h-auto hover:scale-105 transform transition-transform duration-200"
                  />
                  <span className="absolute left-1/2 -translate-x-1/2 bottom-10 bg-gray-800 text-white text-xs rounded py-1 px-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                ...
                <div className="relative group">
                  <img
                    src='https://res.cloudinary.com/dzk36cfdq/image/upload/v1753653053/pix_ur0vl2.png'
                    alt="Pix"
                    className="w-8 h-auto hover:scale-105 transform transition-transform duration-200"
                  />
                  <span className="absolute left-1/2 -translate-x-1/2 bottom-10 bg-gray-800 text-white text-xs rounded py-1 px-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
