  ...
  return (
    <div ref={sectionRef} className="py-8 bg-gray-50">
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-5xl mx-auto mb-16 animate-on-scroll opacity-0">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-3">Nossos Serviços</h2>
